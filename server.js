const express = require('express'); // Se incluye el modulo express para la creacion del servidor
const router = express.Router(); // Router, importante para poder diferenciar las peticiones al maximo
const rp = require('request-promise'); //Se agrega el modulo de request-promise para realizar el POST y el GET

// Se incluye modulo validator para realizar las validaciones de los atributos del JSON
...
app.use(router); // Agregamos router a nuestra aplicacion de express para separar los verbos
...
router.get('/', function(req, res){    
    // Se entrega como respuesta al GET un HTML (formulario)    
